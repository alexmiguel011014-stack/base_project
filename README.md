...
- `/usagebp` no longer crashes on large ledgers; the ledger masks secrets before writing, and `dev/scripts/ledger-prune.js` trims it on request (dry run by default)
