...
| `/audit` | Security scan (dependency vulnerabilities, exposed secrets). Uses Strix if installed. |
| `/plugins` | Looks at the current project, recommends which optional plugins fit, and installs the ones you pick. |
| `/council` | Pressure-tests a hard decision through 5 independent advisor perspectives + a synthesized verdict. |
