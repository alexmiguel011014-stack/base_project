...
Commands: newproject, newgoal, repertoire, execgoals, scanproject, cleanproject, fixproject, diario, undo, ship, pr, bootstrap, audit, plugins, council, designreview, wpp, status, reviewusage, update, uninstall
