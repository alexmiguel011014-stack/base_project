...
This directory is the versioned, append-only history for completed base_project plans. Each entry preserves the original section body from root `GOALS.md`; active work stays in the root file so planning and execution do not repeatedly load finished detail.

Do not rewrite archived bodies during ordinary planning. Add a new active plan for new work; consult an archived body only to verify historical scope or avoid duplication.
...
| GOALS 13 — Command Suite Cleanup & Goal-Archive Automation | completed | [goals-13-command-suite-cleanup-and-goal-archive-automation.md](./goals-13-command-suite-cleanup-and-goal-archive-automation.md) | `2f5803a17cbfc61d105c49c4b21e49de820c3b7887e2ef228de6efb5dfc49d48` |
| GOALS 16 — Multi-Agent Branch & Worktree Isolation Policy | completed | [goals-16-multi-agent-branch-worktree-isolation-policy.md](./goals-16-multi-agent-branch-worktree-isolation-policy.md) | `723a79746608c38238b5a3aca2fa0b8ce9099e7426c887bf867c3450bddf0aed` |
