...
foreach ($staleCmd in @((Join-Path $claudeCommandsDir "dashboard.md"), (Join-Path $opencodeCommandDir "dashboard.md"), (Join-Path $claudeCommandsDir "doctor.md"), (Join-Path $opencodeCommandDir "doctor.md"), (Join-Path $claudeCommandsDir "context.md"), (Join-Path $opencodeCommandDir "context.md"), (Join-Path $claudeCommandsDir "explain.md"), (Join-Path $opencodeCommandDir "explain.md"), (Join-Path $claudeCommandsDir "reviewusage.md"), (Join-Path $opencodeCommandDir "reviewusage.md"))) {
